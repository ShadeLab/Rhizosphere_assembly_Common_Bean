...
#height_growth_V1 <- t.test(predry ~ group, data = growth_V1, na.action = "na.omit")
#height_growth_V1 # ** .004
...
### Root analysis
```{r}
data_root_length <- read.csv("/Users/Abby/OneDrive - Michigan State University/Rhizo_assembly/root_length_data_all.csv", header=TRUE)
